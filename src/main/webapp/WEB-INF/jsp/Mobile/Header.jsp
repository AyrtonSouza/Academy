<title>Academy System</title>
  ...
  <link rel="stylesheet" href="http://code.jquery.com/mobile/1.3.2/jquery.mobile.structure-1.3.2.min.css"/> 
    ...
    <script type='text/javascript' src='../../../inb/resources/js/bootstrap.min.js'></script>    
    
   <!-- 
    <script type='text/javascript' src='../../../resources/js/plugins/mcustomscrollbar/jquery.mCustomScrollbar.min.js'></script>
    <script type='text/javascript' src='../../../resources/js/plugins/uniform/jquery.uniform.min.js'></script>
    
    <script type='text/javascript' src='../../../resources/js/plugins/knob/jquery.knob.js'></script>
    ...
    <script type='text/javascript' src='../../../resources/js/settings.js'></script>   -->
     ...
     <link rel="stylesheet" href="../../../inb/resources/css/style.css" />
